...
export default function BrowsePage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <div className="bg-[#1c1d1f] text-white py-8 sm:py-12 lg:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-4 sm:mb-6 rounded-lg bg-[#c9975b] flex items-center justify-center">
            <BookOpen className="w-6 h-6 sm:w-8 sm:h-8 text-white" />
          </div>
          <h1 className="text-2xl sm:text-4xl lg:text-5xl font-bold mb-3 sm:mb-4 tracking-tight">
            Learning Paths
          </h1>
          <p className="text-sm sm:text-lg lg:text-xl text-gray-400 max-w-2xl mx-auto px-4">
